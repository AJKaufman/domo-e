  ...
  return (
   <form id="domoForm" 
    ...
    >
      ...
      <label htmlFor="domoDexNumber">Number (1-151): </label>
      <input id="domoDexNumber" type="text" name="domoDexNumber" placeholder="DomoDex # (1-151)"/>
...
const renderDomoList = function() {
  ...
  const domoNodes = this.state.data.map(function(domo) {
    ...
    <div key={domo._id} className="domo">
      ...
      <h3 className="domoDexNumber"> DomoDex Number: {domo.domoDexNumber} </h3>
    </div>
    );    
  });
